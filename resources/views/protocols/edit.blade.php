    ...
    <div class="container mx-auto">
        ...
        <form action="{{ route('protocols.update', $protocol->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="title" name="title" value="{{ old('title', $protocol->title) }}"
                    class="border border-gray-300 rounded p-2 w-full">
            </div>

            <div class="mb-4">
                <label for="number" class="block text-gray-700 font-bold mb-2">Number</label>
                <input type="text" id="number" name="number" value="{{ old('number', $protocol->number) }}"
                    class="border border-gray-300 rounded p-2 w-full">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="date" name="date"
                    value="{{ old('date', $protocol->date->format('Y-m-d')) }}"
                    class="border border-gray-300 rounded p-2 w-full">
            </div>
