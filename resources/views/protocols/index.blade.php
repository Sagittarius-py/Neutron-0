        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-100">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <a href="{{ route('protocols.show', $protocol) }}" class="text-blue-600 hover:text-blue-900 mr-4">View</a>
                    <a href="{{ route('protocols.edit', $protocol) }}" class="text-green-600 hover:text-green-900 mr-4">Edit</a>
                    <a href="{{ route('protocols.destroy', $protocol) }}" class="text-red-600 hover:text-red-900">Delete</a>
                </td>
            </tr>
            @empty
            <tr>
