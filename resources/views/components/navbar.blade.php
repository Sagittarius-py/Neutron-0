        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex" style="gap: 10px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity">
                ...
                <div class="hidden md:block">
                    ...
                    <a href="/devices" class="text-gray-300 hover:text-white px-4">Urządzenia testowe</a>
                    <a href="/customers" class="text-gray-300 hover:text-white px-4">Zleceniodawcy</a>
                    @else
